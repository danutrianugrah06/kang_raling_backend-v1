...
class ApiKeyController extends Controller
{
    #[OA\Get(
        ...
        description: 'Mengembalikan daftar API Key (token interop) yang sudah dibuat. Koordinator melihat semua API Key dari semua developer eksternal, sedangkan Developer Eksternal hanya melihat API Key miliknya sendiri. Token login (`auth_token`) tidak ditampilkan di sini.',
        tags: ['API Key & Log'],
        security: [['bearerAuth' => []]],
        responses: [
            new OA\Response(
    ...
    #[OA\Delete(
        ...
        description: 'Mencabut/menghapus API Key secara permanen. Setelah dihapus, token tidak bisa lagi digunakan untuk mengakses endpoint interop. Koordinator bisa hapus API Key milik siapapun, Developer Eksternal hanya bisa hapus miliknya sendiri.',
        tags: ['API Key & Log'],
        security: [['bearerAuth' => []]],
        parameters: [
